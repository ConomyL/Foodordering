            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>RM
                            ...
                            <asp:HiddenField ID="hdnProductId" runat="server" Value='<%# Eval("ProductId") %>'></asp:HiddenField>
                            <asp:HiddenField ID="hdnQuantity" runat="server" Value='<%# Eval("Qty") %>'></asp:HiddenField>
                            <asp:HiddenField ID="hdnPrdQuantity" runat="server" Value='<%# Eval("PrdQty") %>'></asp:HiddenField>
                        ...
                        <td>RM<asp:Label ID="lblTotalPrice" runat="server"  ></asp:Label></td>
                        <td><asp:LinkButton ID="lbDelete" runat="server"  Text="Remove" CommandName="remove" CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Do you want to remove this item from cart?');">
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td>RM<%Response.Write(Session["grandTotalPrice"]); %></td>
                        <td></td>
                    </tr>
                    <tr>
