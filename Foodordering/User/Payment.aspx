                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            <label for="txtOrderTakingTime">
                                                Order Taking Time
                                            </label>
                                            <asp:RequiredFieldValidator ID="rfvOrderTakingTime" runat="server" ErrorMessage="Order Taking Time is required" ForeColor="Red"
                                                ControlToValidate="txtOrderTakingTime" Display="Dynamic" SetFocusOnError="true" ValidationGroup="card">*
                                            </asp:RequiredFieldValidator>
                                            <asp:TextBox ID="txtOrderTakingTime" runat="server" CssClass="form-control" placeholder="Order Taking Time"
                                                TextMode="Time" ValidationGroup="card"></asp:TextBox>
                                        </div>
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        <label for="txtCODOrderTakingTime">
                                            Order Taking Time
                                        </label>
                                        <asp:TextBox ID="txtCODOrderTakingTime" runat="server" CssClass="form-control" placeholder="OrderTakingTime"
                                            TextMode="Time"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvCODOrderTakingTime" runat="server" ErrorMessage="Order Taking Time is required" ForeColor="Red"
                                            ControlToValidate="txtCODOrderTakingTime" Display="Dynamic" SetFocusOnError="true" ValidationGroup="cod"
