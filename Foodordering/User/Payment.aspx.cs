...
namespace Foodordering.User
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        string _name = string.Empty; string _cardNo = string.Empty; string _expiryDate = string.Empty; string _cvv = string.Empty; string _orderTakingTime = string.Empty; string _paymentMode = string.Empty;
        ...
        protected void lbCardSubmit_Click(object sender, EventArgs e)
        {
            ...
            _orderTakingTime = txtOrderTakingTime.Text.Trim();
            _paymentMode = "card";
            if (Session["userId"] != null)
            {
                OrderPayment(_name, _cardNo, _expiryDate, _cvv, _orderTakingTime, _paymentMode);
            }
            else
            {
                Response.Redirect("Login.aspx");
        ...
        {
            _orderTakingTime = txtCODOrderTakingTime.Text.Trim();
            _paymentMode = "cod";
            if (Session["userId"] != null)
            {
                OrderPayment(_name, _cardNo, _expiryDate, _cvv, _orderTakingTime, _paymentMode);
        ...
        void OrderPayment(string name, string cardNo, string expiryDate, string cvv, string orderTakingTime, string paymentMode)
        {
            ...
            cmd.Parameters.AddWithValue("@OrderTakingTime", orderTakingTime);
