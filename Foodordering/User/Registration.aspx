            ...
            <div class="row">
                    <div class="col-md-6">
                        <div class="form_container">
                            ...
                            <div>
                                <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Username is required" ControlToValidate="txtUsername"
                                    ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="revUserName" runat="server" ErrorMessage="UserName must in character only"
                                    ForeColor="Red" Display="Dynamic" ValidationExpression="^[a-zA-z\s]+$"
                        ...
                        <div class="form_container">
                            ...
                            <div>
                                <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ErrorMessage="Password is required" ControlToValidate="txtMobile"
                                    ControlToValidation="txtPassword" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <div>
                                <asp:RequiredFieldValidator ID="rfvConfirmPassword" runat="server" ErrorMessage="Password is required" ControlToValidate="txtConfirmPassword"
                                    ControlToValidation="txtConfirmPassword" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
