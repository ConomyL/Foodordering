                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtDecription" runat="server" CssClass="form-control"
                                                            placeholder="Enter Product Decription" TextMode="MultiLine"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                            ErrorMessage="Decription is required" ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="txtDecription">
                                                ...
                                                <div>
                                                    <asp:Image ID="imgProduct" runat="server" CssClass="img-thumball" />
                                                </div>
                                            </div>
                                        </div>
